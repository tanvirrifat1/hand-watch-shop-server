...
const interIntoDb = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield reviews_model_1.Reviews.create(payload);
    return result;
});
const getAllData = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield reviews_model_1.Reviews.find();
    return result;
});
const deleteData = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield reviews_model_1.Reviews.findByIdAndDelete(id, { new: true });
    return result;
});
